		...
		<div class="row">
		    ...
		    <strong></strong>${msg }
								...
								<form id="profile" action="profile" method="post"  >
									...
									<div class="form-group">
										<label> Status </label>
										<c:if test="${loginUser.active==true }">
										<input type="email" name="status" id="status"  value="Active" tabindex="2" class="form-control" readonly="readonly">
									    </c:if>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4"></div>
											<div class="col-sm-4">
												<input type="submit" name="register-submit" style="border-radius:0px;" id="register-submit" class="btn btn-success" value="Update Profile">
											</div>
											<div class="col-sm-4"></div>
										</div>
									</div>
