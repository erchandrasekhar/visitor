...
<div class="row">
  <div class="col-sm-6">
    ...
    <div class="card">
	  <div class="card-header bg-danger text-white">${ pendingVisitorsForApproval.size()} Visitors Pending For Approval&nbsp;<b style="color: white;"></b></div>
	  <div class="card-body">
...
<div id="accordion1">
  ...
  <div class="card">
    <div class="card-header d-flex">
      ...
      <a class="btn btn-danger btn-sm"style="border-radius:0px;">Reject</a>
 ...
 <%--    <div class="card">
	  <div class="card-header bg-danger text-white">${ pendingVisitorsForApproval.size()} Vehicles Pending for your Approval&nbsp;<b style="color: white;"></b></div>
	  <div class="card-body">
